{{-- resources/views/roba/edit.blade.php --}}
...
<div class="container py-4">
    ...
    <div class="card">
        <div class="card-body">
            <form method="POST" action="{{ route('robas.update', $roba->id) }}">
                @csrf
                @method('PUT')
                ...
                <div class="mb-3">
                    ...
                    <input type="number" id="kolicina" name="kolicina"
                           ...
                           value="{{ old('kolicina', $roba->kolicina) }}"
                           required>
                ...
                <div class="mb-3">
                    ...
                    <input type="text" id="jedinica_mere" name="jedinica_mere"
                           ...
                           value="{{ old('jedinica_mere', $roba->jedinica_mere) }}"
                           maxlength="10"
                           required>
